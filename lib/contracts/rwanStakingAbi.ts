...
export const RWAN_STAKING_ABI = [
  ...
  {
    "type": "function",
    "name": "accRewardPerWeightedToken",
    "inputs": [],
    "outputs": [
      {
        "name": "",
